...
<div class="space-y-6">
        ...
        <form method="GET" action="{{ route('subjects.index') }}">
            ...
            <div class="flex flex-col lg:flex-row gap-3">
                ...
                <input
                    ...
                    placeholder="Search by Subject Code, Subject Name or Department"
    ...
    <a href="{{ route('subjects.edit', $subject->SubjectID) }}"
    ...
    <form method="POST"
          action="{{ route('subjects.destroy', $subject->SubjectID) }}"
