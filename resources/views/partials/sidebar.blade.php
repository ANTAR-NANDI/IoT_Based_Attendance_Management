<aside class="w-64 bg-slate-900 text-slate-300 flex flex-col h-full shadow-xl z-20">
    ...
    <nav class="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto">
        ...
        <a onclick="window.location.href='{{ route('teachers.index') }}'" href="#" class="flex items-center space-x-3 px-4 py-2 rounded-lg text-sm font-medium text-slate-400 hover:bg-slate-800 hover:text-slate-100 transition">
            <span class="text-sm">🏢</span>
            <span>Teachers</span>
        </a>
        <a onclick="window.location.href='{{ route('subjects.index') }}'" href="#" class="flex items-center space-x-3 px-4 py-2 rounded-lg text-sm font-medium text-slate-400 hover:bg-slate-800 hover:text-slate-100 transition">
            <span class="text-sm">🏢</span>
            <span>Subjects</span>
        </a>
        ...
        <a onclick="window.location.href='{{ route('rooms.index') }}'" href="#" class="flex items-center space-x-3 px-4 py-2 rounded-lg text-sm font-medium text-slate-400 hover:bg-slate-800 hover:text-slate-100 transition">
            <span class="text-sm">🏢</span>
            <span>Rooms</span>
        </a>
