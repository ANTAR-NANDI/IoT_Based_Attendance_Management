...
class AttendanceLogController extends Controller
{
    ...
    public function exportPdf(Request $request)
    {
        ...
        $filename = 'class-attendance-' . $fromDate . '-to-' . $toDate . '.pdf';

        return $pdf->download($filename);
    }

    /**
     * Shared reconciliation logic used by both the screen view and the PDF export.
     * Returns [Collection $report, Collection $summary, string $fromDate, string $toDate]
     */
